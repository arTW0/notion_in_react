...
export function Editor() {
  ...
  return <>
    ...
    {editor && (
      <FloatingMenu
        className="bg-zinc-700 py-1 px-1 gap-1 shadow-xl border border-zinc-600 shadow-black/20 rounded-lg overflow-hidden flex-col"
        editor={editor}
        shouldShow={({ state }) => {
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col text-left">
            ...
            <span className="text-xs text-zinc-400">Big selection heading.</span>
          </div>
        </button>
      </FloatingMenu>
    )}
